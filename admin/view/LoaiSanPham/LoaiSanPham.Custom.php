<div class="container mt-5">
    ...
    <form method="post">
        <div class="form-group">
            <input type="hidden" name="id_loai_san_pham" value="<?php echo $category_details['id']; ?>">
        </div>
        <div class="form-group">
            <label for="new_ten_loai_san_pham">Tên:</label>
            <input type="text" class="form-control" id="new_ten_loai_san_pham" name="new_ten_loai_san_pham" value="<?php echo $category_details['name']; ?>" required>
        </div>
        <div class="form-group">
            <label for="new_mo_ta">Mô tả:</label>
            <textarea class="form-control" id="new_mo_ta" name="new_mo_ta"><?php echo $category_details['description']; ?></textarea>
        </div>
