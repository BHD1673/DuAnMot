...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql = 'UPDATE `bien_the` SET `ten_bien_the` = ? WHERE `bien_the`.`id` = ?';

    pdo_execute($sql, $variant_name, $_GET['id']);
...
<div class="container mt-5">
    ...
    <form method="post" enctype="multipart/form-data">
        <div class="row">
            ...
            <label for="variant_name">Chi tiết biến thể số <?php echo $_GET['id'] ?></label>
            </div>
