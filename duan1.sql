...
CREATE TABLE `don_hang` (
  `id` int NOT NULL,
  `id_nguoi_dung` int NOT NULL,
  `id_dia_chi_nguoi_dung` int NOT NULL,
...
ALTER TABLE `chi_tiet_don_hang`
  ...
  ADD KEY `chi_tiet_don_hang_ibfk_2` (`id_san_pham_bien_the`);
...
ALTER TABLE `don_hang`
  ADD PRIMARY KEY (`id`),
  ADD KEY `don_hang_ibfk_1` (`id_nguoi_dung`),
  ADD KEY `don_hang_ibfk_2` (`id_dia_chi_nguoi_dung`);
...
ALTER TABLE `chi_tiet_don_hang`
  ...
  ADD CONSTRAINT `chi_tiet_don_hang_ibfk_2` FOREIGN KEY (`id_san_pham_bien_the`) REFERENCES `san_pham_bien_the` (`id`);
ALTER TABLE `dia_chi_nguoi_dung`
