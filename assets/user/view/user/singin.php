...
<div class="form sign-in">
            ...
            <p class="forgot-pass"><a href="index2.php?act=forgot" style="color: black;">Forgot password?</a></p>
            <button type="button" class="submit" onclick="signIn()" name="dangnhap"><a href="" style="color: black;">Sign In</a></button>
</div>
        <div class="sub-cont">
            <div class="img">
  ...
  <button type="button" class="submit" onclick="signUp()" name="dangky"><a href="" style="color: black;">Sign Up</a></button>
</form>
