                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable ps-container ps-theme-default" data-ps-id="ebdd35f1-6505-2d62-f94c-4e006d404e69">
                                <!-- Comment Row -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="todo-widget scrollable ps-container ps-theme-default ps-active-y" style="height:450px;" data-ps-id="6d69d9f0-10f1-41ee-cbc3-74ea980ad45b">
                                ...
                                <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 450px; right: 3px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 438px;"></div></div></div>
                            </div>
                        </div>
                        <!-- card -->
                        <div class="card">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="chat-box scrollable ps-container ps-theme-default ps-active-y" style="height:475px;" data-ps-id="a17d370b-28d7-c997-fb4b-ba6dd17247a2">
                                    <!--chat Row -->
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        <li class="chat-item">
                                ...
                                <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 475px; right: 3px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 443px;"></div></div></div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable ps-container ps-theme-default ps-active-y" style="max-height: 130px;" data-ps-id="c9c93747-ea68-057a-4e42-192d11183657">
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2"><img src="assets/images/users/1.jpg" alt="user" width="50" class="rounded-circle"></div>
                                    <div class="comment-text w-100">
                            ...
                            <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 130px; right: 3px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 44px;"></div></div></div>
                        </div>
                        <!-- accoridan part -->
...
<div class="flotTip" style="display: none; position: absolute;"></div></body>
